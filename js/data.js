...
const blogs = [

    {
        ...
        title:
            "Hướng dẫn tập gym cho người mới bắt đầu: từ buổi đầu đến 8 tuần đầu tiên",

        icon:
            "GYM",

        excerpt:
            "Lộ trình nền tảng giúp người mới biết bắt đầu từ đâu, tập bao nhiêu buổi, chọn bài thế nào và tăng tiến ra sao.",

        content: article([

            {
                h:
                    "1. Đừng bắt đầu bằng việc tìm “lịch tập nặng nhất”",
            ...
            {
                h:
                    "2. Học 6 mẫu chuyển động cơ bản",
                ...
                note: {
                    ...
                    text:
                        "Hãy quay một đoạn video ngắn ở góc ngang khi học squat hoặc hinge. Video giúp bạn nhìn ra tư thế dễ hơn so với chỉ dựa vào cảm giác."
                }
            },
            ...
            {
                h:
                    "6. Những dấu hiệu nên giảm cường độ",
...

    {
        ...
        title:
            "Protein cho người tập gym: hiểu đúng, ăn đủ và phân bổ hợp lý trong ngày",

        icon:
            "PRO",

        excerpt:
            "Giải thích vai trò của protein, cách chọn nguồn thực phẩm và cách xây bữa ăn thực tế mà không phụ thuộc vào thực phẩm bổ sung.",

        content: article([

            {
                h:
                    "1. Protein không chỉ dành cho người muốn “to cơ”",
            ...
            {
                h:
                    "2. Nguồn protein dễ dùng trong bữa ăn Việt Nam",
            ...
            {
                h:
                    "3. Phân bổ protein thay vì dồn hết vào một bữa",
            ...
            {
                h:
                    "4. Protein powder có bắt buộc không?",
            ...
            {
                h:
                    "5. Đừng quên carbohydrate, chất béo và rau quả",
            ...
            {
                h:
                    "6. Cách xây một đĩa ăn đơn giản",
...

    {
        ...
        title:
            "Cách chọn giày chạy bộ phù hợp: size, độ đệm, độ bám và mục đích sử dụng",

        icon:
            "RUN",

        excerpt:
            "Một hướng dẫn thực tế để chọn giày theo kiểu chạy, bàn chân và cảm giác khi thử thay vì chỉ nhìn thương hiệu.",

        content: article([

            {
                h:
                    "1. Bắt đầu từ mục đích sử dụng",
            ...
            {
                h:
                    "2. Size chạy bộ không nhất thiết giống giày đi chơi",
            ...
            {
                h:
                    "3. Độ đệm: nhiều hơn không phải lúc nào cũng tốt hơn",
            ...
            {
                h:
                    "4. Kiểm tra độ bám và bề mặt chạy",
...

    {
        ...
        title:
            "10 bài tập tăng sức mạnh tại nhà không cần máy tập",

        icon:
            "HOME",

        excerpt:
            "Một chương trình toàn thân dùng trọng lượng cơ thể và đồ dùng đơn giản, phù hợp người muốn tập tại nhà.",

        content: article([

            {
                h:
                    "1. Nguyên tắc để tập tại nhà vẫn tiến bộ",
            ...
            {
                h:
                    "4. Nhóm kéo - bài khó nhất khi tập tại nhà",
...

    {
        ...
        title:
            "Cardio bao nhiêu phút mỗi ngày là phù hợp? Cách chia thời lượng theo mục tiêu",

        icon:
            "CARDIO",

        excerpt:
            "Hiểu cách bố trí cardio cho sức khỏe, giảm mỡ và sức bền mà không làm ảnh hưởng quá nhiều đến phục hồi.",

        content: article([

            {
                h:
                    "1. Không cần cardio mỗi ngày mới có lợi",
            ...
            {
                h:
                    "2. Phân biệt cardio nhẹ và cardio nặng",
...

    {
        ...
        title:
            "Squat đúng kỹ thuật: cách đặt chân, kiểm soát thân người và sửa lỗi thường gặp",

        icon:
            "SQ",

        excerpt:
            "Phân tích squat theo nguyên tắc chuyển động để bạn tự điều chỉnh theo cấu trúc cơ thể và mục tiêu.",

        content: article([

            {
                h:
                    "1. Không tồn tại một tư thế squat giống hệt cho tất cả",
            ...
            {
                h:
                    "5. Đau không phải là phần bắt buộc của squat",
...

    {
        ...
        title:
            "7 lỗi phổ biến khi tập gym khiến bạn khó tiến bộ dù đi tập rất đều",

        icon:
            "ERR",

        excerpt:
            "Những sai lầm về chương trình, mức tạ, kỹ thuật và phục hồi thường làm người tập “đứng yên” trong nhiều tháng.",
        ...
        content: article([
            ...
            {
                h:
                    "7. Đánh giá tiến bộ chỉ bằng cân nặng",
...

    {
        ...
        title:
            "Phục hồi cơ bắp sau tập: ngủ, dinh dưỡng, vận động nhẹ và cách dùng foam roller",

        icon:
            "REC",

        excerpt:
            "Một quy trình phục hồi thực tế giúp bạn quay lại buổi tập tiếp theo với chất lượng tốt hơn.",

        content: article([

            {
                h:
                    "1. Phục hồi bắt đầu ngay từ cách bạn lập chương trình",
...

    {
        ...
        title:
            "Uống nước khi tập thể thao: cách nhận biết thiếu nước và xây thói quen phù hợp",

        icon:
            "H2O",

        excerpt:
            "Hướng dẫn thực tế về nước trước, trong và sau vận động mà không biến thành những con số cứng nhắc.",

        content: article([

            {
                h:
                    "1. Nhu cầu nước thay đổi rất nhiều",
            ...
            {
                h:
                    "4. Điện giải khi nào có ý nghĩa?",
...

    {
        ...
        title:
            "Nên tập buổi sáng hay buổi tối? Cách chọn khung giờ giúp bạn duy trì lâu dài",

        icon:
            "TIME",

        excerpt:
            "So sánh ưu nhược điểm của các khung giờ và cách chọn thời điểm phù hợp lịch sống.",

        content: article([

            {
                h:
                    "1. Thời điểm tốt nhất là thời điểm bạn duy trì được",
...

    {
        ...
        title:
            "7 bài tập bụng và core tại nhà: từ người mới đến mức trung bình",

        icon:
            "CORE",

        excerpt:
            "Không cần hàng trăm lần gập bụng; hãy học cách chống duỗi, chống xoay và kiểm soát thân người.",
        ...
        content: article([
            ...
            {
                h:
                    "7. Mountain climber chậm và suitcase carry",
...

    {
        ...
        title:
            "Cách duy trì động lực tập luyện khi bận rộn hoặc dễ bỏ cuộc",

        icon:
            "MIND",

        excerpt:
            "Biến việc tập thành hệ thống thay vì phụ thuộc vào cảm hứng.",

        content: article([

            {
                h:
                    "1. Động lực không ổn định là bình thường",
...

    {
        ...
        title:
            "Lịch tập gym 5 ngày: cách bố trí nhóm cơ để vừa tiến bộ vừa có thời gian phục hồi",

        icon:
            "5DAY",

        excerpt:
            "Một mẫu 5 ngày thực tế với cách điều chỉnh volume theo kinh nghiệm.",

        content: article([

            {
                h:
                    "1. 5 buổi không tự động tốt hơn 3-4 buổi",
            ...
            {
                h:
                    "2. Mẫu Upper/Lower + Push/Pull/Legs",
...

    {
        ...
        title:
            "Khởi động trước khi tập: 8-12 phút làm gì để vừa đủ mà không bị mệt trước bài chính",

        icon:
            "WARM",

        excerpt:
            "Một cấu trúc warm-up từ tăng nhiệt cơ thể đến set khởi động chuyên biệt.",

        content: article([

            {
                h:
                    "1. Mục tiêu của warm-up",
...

    {
        ...
        title:
            "Tăng sức bền chạy bộ: xây nền aerobic, tăng quãng đường và tránh tăng tải quá nhanh",

        icon:
            "END",

        excerpt:
            "Lộ trình giúp người mới chạy lâu hơn mà không cần biến mọi buổi thành chạy hết sức.",

        content: article([

            {
                h:
                    "1. Chạy chậm là phần quan trọng",
...

    {
        ...
        title:
            "Có nên tập gym mỗi ngày? Phân biệt vận động hằng ngày với tập nặng hằng ngày",

        icon:
            "7D",

        excerpt:
            "Bạn có thể hoạt động mỗi ngày nhưng không nhất thiết phải đặt cơ thể vào buổi tập nặng mỗi ngày.",

        content: article([

            {
                h:
                    "1. “Tập mỗi ngày” có nhiều nghĩa",
            ...
            {
                h:
                    "2. Người mới thường không cần 7 buổi gym",
...

    {
        ...
        title:
            "Cách chọn găng tay tập gym: khi nào hữu ích, chọn size và chất liệu thế nào",

        icon:
            "GRIP",

        excerpt:
            "Găng tay không bắt buộc, nhưng có thể tăng sự thoải mái và độ bám cho một số người.",

        content: article([

            {
                h:
                    "1. Găng tay có tác dụng gì?",
...

    {
        ...
        title:
            "Dây kháng lực: 12 bài tập toàn thân và cách chọn mức lực phù hợp",

        icon:
            "BAND",

        excerpt:
            "Một bộ dây nhỏ nhưng có thể dùng cho mông, lưng, vai, tay và bài activation.",
...

    {
        ...
        title:
            "Thực phẩm tốt cho người tập gym: cách xây danh sách mua sắm một tuần",

        icon:
            "FOOD",

        excerpt:
            "Từ protein, tinh bột, chất béo đến rau quả: một danh sách đơn giản để bữa ăn dễ chuẩn bị và dễ duy trì.",

        content: article([

            {
                h:
                    "1. Đừng mua theo “thực phẩm thần kỳ”",
...

    {
        ...
        title:
            "Stretching sau tập có tác dụng gì? Khi nào nên kéo giãn và khi nào không cần cố",

        icon:
            "FLEX",

        excerpt:
            "Phân biệt stretching để thư giãn, cải thiện biên độ vận động và điều trị chấn thương.",

        content: article([

            {
                h:
                    "1. Stretching không phải “xóa axit lactic”",
            ...
            {
                h:
                    "4. Muốn tăng flexibility cần tính nhất quán",
            ...
            {
                h:
                    "5. Đừng kéo giãn vào cơn đau sắc",
...
function validateUniqueIds(items, label) {
    ...
    items.forEach(item => {
        ...
        if (
            ...
            console.warn(
                `[SPORTHUB] ${label} có ID không hợp lệ:`,
                item
            );
        ...
        if (ids.has(id)) {
            ...
            console.warn(
                `[SPORTHUB] Phát hiện ID trùng trong ${label}:`,
                id
            );
...
console.info(
    `[SPORTHUB] Core data loaded: ${products.length} sản phẩm gốc, ${blogs.length} bài blog.`
);